...
- Added a coach-facing [weekly report guide](site/guides/weekly-report.md) for
  `report.weekly` (VW-292): what the header's rolling 28-day count and adherence trend
