...
**123 tools** are registered with the real adapter (`VOLTRA_ADAPTER=node`) and
**125** in mock mode — the `mock.*` namespace is registered only when
...
| [`plan.*`](./plan)                     | 24    | always registered |
