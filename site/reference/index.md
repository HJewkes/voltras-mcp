...
**111 tools** are registered with the real adapter (`VOLTRA_ADAPTER=node`) and
**113** in mock mode — the `mock.*` namespace is registered only when
...
| [`profile.*`](./profile)               | 8     | always registered |
