...
**124 tools** are registered with the real adapter (`VOLTRA_ADAPTER=node`) and
**126** in mock mode — the `mock.*` namespace is registered only when
...
| [`plan.*`](./plan)                     | 25    | always registered |
