...
**97 tools** are registered with the real adapter (`VOLTRA_ADAPTER=node`) and
**99** in mock mode — the `mock.*` namespace is registered only when
...
| [`profile.*`](./profile)         | 6     | always registered |
