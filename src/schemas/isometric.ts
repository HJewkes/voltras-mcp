...
//
// The testing-protocol parameters (defaults + clamps) come from an internal
// review of the isometric-assessment literature dated 2026-05-09, held
// outside this repo. Each clamp reflects a published evidence range from
// that review. Defaults match the unilateral baseline (5s holds × 3
