...
| Tool | Location |
| --- | --- |
| `device.start_guided_load` | `src/tools/device-tools.ts:1029` |
| `device.exit_guided_load` | `src/tools/device-tools.ts:1177` |
| `device.unload` | `src/tools/device-tools.ts:1003` |
