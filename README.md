...
| `profile.*`     | 4     | Self-reported training background (get/set), the derived tier signal, and `get_starting_prescription` — conservative tier-seeded sessions/week, sets/exercise and RIR target. Advisory: it applies nothing.                                                                                                                                                                                                                                                                                                                                                                    |
