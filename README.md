...
| `metrics.*`     | 1     | `compute` — runs an analytics pipeline over a session, a set, or a set-id array, including `strength.e1rm` (VW-142) — Epley/profile/hybrid 1RM estimates from `{ load, reps }`, `{ exerciseId }`, or both. Dispatches to `@voltras/workout-analytics`; no analytics logic is reimplemented here.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
